...
BufferManager::BufferManager(SharedMemory& _sharedMemory) :
...
void BufferManager::SetSnakeWriteAttributes(const Structure::RenderInfo& _renderInfo)
{
...
void BufferManager::WriteIntoBuffer(const Structure::RenderInfo& _renderInfo)
{
