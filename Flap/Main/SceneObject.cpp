...
bool SceneObject::CheckPositionValidity(Structure::Vector2<int>& _position)
{
	...
	return !(_position.m_x < Consts::NO_VALUE || 
			 _position.m_y < Consts::NO_VALUE ||
			 _position.m_x == sp_sharedGame->m_gameAreaBounds.m_x ||
			 _position.m_y == sp_sharedGame->m_gameAreaBounds.m_y);
}
